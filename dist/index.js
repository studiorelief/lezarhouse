...
(() => {
  ...
  var require_vanilla_tilt = __commonJS({
    "node_modules/.pnpm/vanilla-tilt@1.8.1/node_modules/vanilla-tilt/lib/vanilla-tilt.js"(exports, module) {
      ...
      var VanillaTilt2 = function() {
        ...
        VanillaTilt3.prototype.onDeviceOrientation = function onDeviceOrientation(event2) {
          if (event2.gamma === null || event2.beta === null) {
            return;
          }
          ...
          if (this.gyroscopeSamples > 0) {
            ...
            if (this.gammazero === null) {
              this.gammazero = event2.gamma;
              this.betazero = event2.beta;
            } else {
              this.gammazero = (event2.gamma + this.lastgammazero) / 2;
              this.betazero = (event2.beta + this.lastbetazero) / 2;
            }
          ...
          var angleX = event2.gamma - (this.settings.gyroscopeMinAngleX + this.gammazero);
          var angleY = event2.beta - (this.settings.gyroscopeMinAngleY + this.betazero);
        ...
        VanillaTilt3.prototype.onMouseMove = function onMouseMove(event2) {
          if (this.updateCall !== null) {
            cancelAnimationFrame(this.updateCall);
          }
          this.event = event2;
        ...
        VanillaTilt3.prototype.update = function update2() {
        ...
        VanillaTilt3.prototype.setTransition = function setTransition2() {
          var _this = this;
          clearTimeout(this.transitionTimeout);
        ...
        VanillaTilt3.init = function init4(elements, settings) {
  ...
  function applyHoverEffect() {
    ...
    import_vanilla_tilt.default.init(Array.from(elements), {});
  }

  // src/utils/autoplaylist.ts
  init_live_reload();
  function cmsPlaylist() {
    const scrollCards = document.querySelectorAll(".lab-playlist_scroll-card");
    let currentIndex = 0;
    let intervalId;
    ...
    function activateCard(index) {
      const mainCards = document.querySelectorAll(".lab-playlist_main-card");
    ...
    function resetAutoClick(index) {
      clearInterval(intervalId);
      currentIndex = index;
      intervalId = setInterval(autoClick, 2e3);
    }
    scrollCards[0].classList.add("is-active");
    intervalId = setInterval(autoClick, 2e3);
  }

  // src/utils/autotabs.ts
  init_live_reload();
  function autoTabs() {
    if (navigator.userAgent.includes("Safari")) {
      document.querySelectorAll(".lab-scene_tabs-link").forEach((tabElement) => {
        ...
        tabButton.focus = function(options) {
    ...
    const changeTab = (currentTab, nextTab) => {
      if (currentTab) {
      ...
      if (nextTab) {
        ...
        const nextLoader = nextTab.querySelector(".lab-scene_loading-tab");
        if (nextLoader) {
    ...
    const tabLoop = () => {
      tabTimeout = window.setTimeout(() => {
        ...
        if (!nextTab) {
          nextTab = document.querySelector(".lab-scene_tabs-link:first-child");
        }
    ...
    document.querySelectorAll(".lab-scene_tabs-link").forEach((button) => {
      button.addEventListener("click", (event2) => {
        ...
        if (tabTimeout !== void 0) {
          clearTimeout(tabTimeout);
        }
        const currentTab = document.querySelector(
          ".lab-scene_tabs-menu .w--current"
        );
        const nextTab = button;
        changeTab(currentTab, nextTab);
        tabLoop();
      });
    });
    document.querySelectorAll(".lab-scene_tabs-link").forEach((tabElement) => {
      const loader = tabElement.querySelector(".lab-scene_loading-tab");
      if (loader) {
        loader.style.transition = "none";
        loader.style.width = "0%";
        loader.style.opacity = "0";
  ...
  function darkModeContent() {
    const updateTextContent = () => {
      const isDarkMode = document.documentElement.classList.contains("w-mod-js") && document.documentElement.classList.contains("dark-mode");
    ...
    const observer = new MutationObserver((mutations) => {
      mutations.forEach((mutation) => {
        if (mutation.attributeName === "class") {
          const event2 = new CustomEvent("classChange");
  ...
  function studioHeroParallax() {
    gsapWithCSS.to(".studio-hero_heading", {
      scrollTrigger: {
        markers: false,
  ...
  function loopBaseline() {
    gsapWithCSS.set(".studio-hero_baseline-wrapper", { x: 0 });
    gsapWithCSS.to(".studio-hero_baseline", {
      xPercent: -100,
      duration: 20,
      repeat: -1,
      yoyo: false,
      ease: "linear",
      modifiers: {
        xPercent: gsapWithCSS.utils.wrap(-100, 0)
      }
    });
  }
  function loopArtists() {
    gsapWithCSS.set(".lab-tool_loop-wrapper", { x: 0 });
    gsapWithCSS.to(".lab-tool_loop", {
      xPercent: -100,
      duration: 20,
      repeat: -1,
      yoyo: false,
  ...
  function loopArtStudio() {
    gsapWithCSS.to(".studio-services_image-w.is-1", {
      rotationZ: 360,
      duration: 20,
      repeat: -1,
      ease: "linear"
    });
    gsapWithCSS.to(".studio-services_image-w.is-3", {
      rotationZ: 360,
      duration: 18,
      repeat: -1,
      ease: "linear"
    });
    gsapWithCSS.to(".studio-services_image-w.is-4", {
      rotationZ: 360,
      duration: 16,
      repeat: -1,
      ease: "linear"
  ...
  function pulseAnimation() {
    gsapWithCSS.set(".lab-platform_circle-shadow-1", { scale: 0, opacity: 0.25 });
    gsapWithCSS.to(".lab-platform_circle-shadow-1", {
      scale: 2.5,
      duration: 3.5,
      opacity: 0,
    ...
    gsapWithCSS.set(".lab-platform_circle-shadow-2", { scale: 0, opacity: 0.5 });
    gsapWithCSS.to(".lab-platform_circle-shadow-2", {
      scale: 2.4,
      duration: 3.5,
      opacity: 0,
      delay: 0.15,
  ...
  function ecosystemRotate() {
    gsapWithCSS.to(".ecosystem-hero_stamp-asset-1", {
      rotation: 360,
      repeat: -1,
      duration: 30,
      ease: "linear"
    });
    gsapWithCSS.to(".ecosystem-hero_stamp-asset-2", {
      rotation: -360,
      repeat: -1,
      duration: 30,
      ease: "linear"
  ...
  function sponsorParallax() {
    gsapWithCSS.to(".sponsorship-hero_heading", {
      scrollTrigger: {
        markers: false,
    ...
    gsapWithCSS.to([".sponsorship-hero_background-image", "#is-sponsor-parallax-main"], {
      scrollTrigger: {
        markers: false,
    ...
    SponsorSections.forEach((section) => {
      ...
      if (parallaxElement) {
        gsapWithCSS.to(parallaxElement, {
          scrollTrigger: {
            markers: false,
            trigger: section,
            scroller: ".main-content-wrapper",
  ...
  function sponsorshipCardsParallax() {
    const sections = document.querySelectorAll(".section_sponsorship-layout");
    sections.forEach((section) => {
      const cardsWrapper = section.querySelector(".sponsorship-layout_cards-wrapper");
      const cards = section.querySelector(".sponsorship-layout_cards");
  ...
  function loopHomeNav() {
    gsapWithCSS.set(".home-hero_page-loop-wrapper", { x: 0 });
    gsapWithCSS.to(".home-hero_page-loop", {
      xPercent: -100,
      duration: 20,
      repeat: -1,
      yoyo: false,
  ...
  function angelsAnimationScroll() {
    gsapWithCSS.to(".c-angels-hero_heading", {
      scrollTrigger: {
        markers: false,
    ...
    gsapWithCSS.to(".c-angels-hero_asset-angel.is-main", {
      scrollTrigger: {
        markers: false,
        trigger: ".section_c-angels-hero",
        scroller: ".main-content-wrapper",
    ...
    gsapWithCSS.set(".c-angels-hero_asset-angel.is-second", { y: "-35rem" });
    gsapWithCSS.to(".c-angels-hero_asset-angel.is-second", {
      scrollTrigger: {
        markers: false,
        trigger: ".section_c-angels-hero",
        scroller: ".main-content-wrapper",
  ...
  function createAngelsCardsParallax() {
    const sections = document.querySelectorAll(".section_c-angels-layout");
    sections.forEach((section) => {
      const cardsWrapper = section.querySelector(".c-angels-layout_cards-wrapper");
      const cardsTop = section.querySelector(".c-angels-layout_cards.is-top");
      const cardsBottom = section.querySelector(".c-angels-layout_cards.is-bottom");
      if (cardsWrapper && cardsTop) {
        gsapWithCSS.to(cardsTop, {
          scrollTrigger: {
            markers: false,
            trigger: cardsWrapper,
            scroller: ".main-content-wrapper",
  ...
  function houseParallax() {
    gsapWithCSS.to(".house-hero_content", {
      scrollTrigger: {
        markers: false,
        trigger: ".section_sponsorship-hero",
        scroller: ".main-content-wrapper",
  ...
  function tabsParallax() {
    gsapWithCSS.to(".lab-scene_image", {
      scrollTrigger: {
        markers: false,
  ...
  // src/utils/lenisScroll.ts
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  var preventScrollClasses = ["c--slider_modal", "form_component"];
  ...
  function toggleSize() {
    const toggleNavbarSize = () => {
      ...
      if (navbarContainer) {
        navbarContainer.style.width = navbarContainer.classList.contains("toggled-size") ? "" : "2.37rem";
    ...
    if (toggleButton)
      toggleButton.addEventListener("click", toggleNavbarSize);
  }
  ...
  // node_modules/.pnpm/swiper@11.1.3/node_modules/swiper/swiper-bundle.mjs
  init_live_reload();
  ...
  function cmsPopup() {
    const openModalButtons = document.querySelectorAll(".a--c--slider-open-modal");
    ...
    openModalButtons.forEach((button) => {
      button.addEventListener("click", () => {
        const { id } = button;
        const modalWrappers = document.querySelectorAll(".c--slider_modal-wrapper");
